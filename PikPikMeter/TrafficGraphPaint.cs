...
namespace PikPikMeter
{
    ...
    class TrafficGraphPaint
    {
        ...
        public TrafficGraphPaint()
        {
            ...
            _notifyIconBitmap = new Bitmap(iconSize.Width, iconSize.Height);
        }
        ...
        public TrafficUnitValue Scale
        {
            ...
            {
                this._scale = value;
                _scaleText = TrafficUnit.Humanize(value) + "/s";
            }
            get
            {
                return this._scale;
        ...
        {
            Paint(_notifyIconBitmap, stat);
            var hicon = _notifyIconBitmap.GetHicon();
        ...
        public void Paint(Bitmap bitmap, TrafficStat stat)
        {
            ...
            try
            {
                ...
                if (CanPaintScale(bitmap))
                    graphics.DrawString(_scaleText, TextFont, TextBrush, 1, 1);
            }
            finally
            {
                graphics.Dispose();
        ...
        {
            return bitmap.Width >= _reasonableScaleTextSize.Width
                && bitmap.Height >= _reasonableScaleTextSize.Height;
        }
    }
}
