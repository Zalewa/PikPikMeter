...
namespace PikPikMeter
{
    public partial class MainWindow : Form
    {
        ...
        private void LoadSettings()
        {
            ...
            _trafficMonitor.GraphOnIcon = Settings.Default.GraphOnTray;
            ...
            _trafficMonitor.GraphPaint.Scale = new TrafficUnitValue(
            ...
            foreach (string disabledNic in Settings.Default.DisabledNics)
                _trafficMonitor.SetNicEnabled(disabledNic, false);
        }
        ...
        private void SaveSettings()
        {
            ...
            Settings.Default.ScaleFactor = _trafficMonitor.GraphPaint.Scale.Value;
            Settings.Default.Bits = _trafficMonitor.GraphPaint.Scale.InBits;
            Settings.Default.GraphOnTray = _trafficMonitor.GraphOnIcon;
        ...
        {
            _trafficMonitor = new TrafficMasterMonitor();
            _trafficMonitor.Display = new TrafficMasterMonitorDisplay()
            {
                Graph = this.GraphBox,
        ...
        {
            if (_moving && e.Button.HasFlag(MouseButtons.Left))
            {
                Point delta = new Point(
                    e.Location.X - _mouseDownLocation.X,
        ...
        {
            if (_resizing && e.Button.HasFlag(MouseButtons.Left))
            {
                Point delta = new Point(
                    e.Location.X - _mouseDownLocation.X,
                    e.Location.Y - _mouseDownLocation.Y);
        ...
        private void setScaleMenuItem_Click(object sender, EventArgs e)
        {
            while (true)
            {
                string scale = TrafficUnit.Humanize(_trafficMonitor.GraphPaint.Scale);
                ...
                if (askValueDialog.ShowDialog(this) == DialogResult.OK)
                {
                    ...
                    _trafficMonitor.GraphPaint.Scale = trafficScale;
                }
                break;
            }
            Repaint();
        ...
        private void graphOnTrayToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            _trafficMonitor.GraphOnIcon = flag;
        ...
        private void interfacesToolStripMenuItem_DropDownOpening(object sender, EventArgs e)
        {
            ...
            string[] measuredNics = _trafficMonitor.KnownMeasuredNics;
